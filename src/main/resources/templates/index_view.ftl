    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item"><a href="/department" target="admin-list" id="deptMngr">部门管理</a>
                    <dl id="datatable" class="layui-nav-child">
...
<#--                <li class="layui-nav-item"><a href="/download" target="admin-list">下载中心</a></li>-->
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px; width: 100%; height: 100%">
            <iframe style="width: 100%; height: 100%;" name="admin-list" scrolling="no" src="/auth"
